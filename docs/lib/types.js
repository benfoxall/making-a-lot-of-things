...
var mozilla = function (fork) {
    ...
    var def = types.Type.def;
    var or = types.Type.or;
    var shared$$2 = fork.use(shared);
    var geq = shared$$2.geq;
    var defaults = shared$$2.defaults;
